...
let
  sources = {
    ...
    "lock-verify-2.1.0" = {
      ...
      version = "2.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/lock-verify/-/lock-verify-2.1.0.tgz";
        sha512 = "vcLpxnGvrqisKvLQ2C2v0/u7LVly17ak2YSgoK4PrdsYBXQIax19vhKiLfvKNFx7FRrpTnitrpzF/uuCMuorIg==";
      };
    };
    "lodash-3.6.0" = {
      name = "lodash";
